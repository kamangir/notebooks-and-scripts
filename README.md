...
built by 🪄 [`abcli-9.250.1-current`](https://github.com/kamangir/awesome-bash-cli), based on [`notebooks_and_scripts-4.677.1`](https://github.com/kamangir/notebooks-and-scripts).
