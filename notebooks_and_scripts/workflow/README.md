...
---
built by [`abcli-9.192.1-current`](https://github.com/kamangir/awesome-bash-cli), based on [`notebooks_and_scripts-4.626.1`](https://github.com/kamangir/notebooks-and-scripts).
